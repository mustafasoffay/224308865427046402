...
client.user.setGame(`King , Ps`,"http://twitch.tv/Death Shop")
...
client.on("message", message => {
    ...
    if (message.content.startsWith(prefix + "224308865427046402")) {
...
const developers = ["525735438602731521" , "650010405590269982"]
client.on('message', message => {
