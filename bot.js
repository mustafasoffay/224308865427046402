...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Desert Bot- Script By : P A N D A `);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : ! S ' `);
    console.log(`----------------`);
  console.log(`Logged in as ${client.user.tag}!`);
client.user.setGame(`P A N D A`,"http://twitch.tv/Death Shop")
client.user.setStatus("dnd")
});



const developers = ["525735438602731521", "586943733770223628", "650010405590269982"] 
